...
use primaria\user\filters\AccessRule;
use primaria\user\Finder;
use primaria\user\models\Profile;
use primaria\user\models\User;
use primaria\user\models\UserSearch;
use primaria\user\helpers\Password;
...
class AdminController extends Controller
{
     ...
     * Triggered with \primaria\user\events\UserEvent.
     */
    ...
    /**
     * If "primaria/yii2-rbac" extension is installed, this page displays form
    ...
    {
        if (!isset(\Yii::$app->extensions['primaria/yii2-rbac'])) {
